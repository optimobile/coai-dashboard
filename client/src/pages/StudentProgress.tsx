          ...
          <Card className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold mt-1">{overallProgress?.avgScore || 0}%</p>
          ...
          <Card className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold mt-1">{overallProgress?.certificateCount || 0}</p>
        ...
        {!loadingQuiz && quizAnalytics && quizAnalytics.totalAttempts > 0 && (
          <Card className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
              ...
              <div className="text-center p-4 bg-secondary/50 rounded-lg">
                <p className="text-sm text-muted-foreground">Average Score</p>
                <p className="text-2xl font-bold mt-1">{quizAnalytics.avgScore}%</p>
              </div>
            </div>

            {/* Score Trend Chart */}
            {quizAnalytics.scoreTrend.length > 0 && (
              <div className="mb-6">
                <h3 className="text-sm font-medium mb-3">Score Trend (Last 10 Quizzes)</h3>
                <ResponsiveContainer width="100%" height={250}>
                  <LineChart data={quizAnalytics.scoreTrend}>
            ...
            {/* Topic Performance */}
            {quizAnalytics.topicPerformance.length > 0 && (
              <div>
                <h3 className="text-sm font-medium mb-3">Performance by Topic</h3>
                <ResponsiveContainer width="100%" height={250}>
                  <BarChart data={quizAnalytics.topicPerformance}>
                    <CartesianGrid strokeDasharray="3 3" />
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <h3 className="font-semibold">{rec.courseName}</h3>
                      ...
                      <p className="text-sm text-muted-foreground">{rec.reasonText}</p>
