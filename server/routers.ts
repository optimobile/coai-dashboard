        ...
        html: `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
            ...
            <div style="padding: 30px; background: #f9fafb;">
              ...
              <p style="color: #666; font-size: 14px;">This report was generated by CSOAI on ${new Date().toISOString().toLocaleDateString()}.</p>
            </div>
...
const regulatorRouter = router({
  ...
  getComplianceTrends: regulatorProcedure.query(async () => {
    ...
    const sixMonthsAgo = new Date().toISOString();
